...
## Structure
The src folder contains entire game logic including:
...
The game is small in scope so all code is in one file for simplicity. The code is structured into logical sections for readability. The proposal.md file contains the project proposal. the requirements.txt file contains the 3rd party library needed to play this game. 
